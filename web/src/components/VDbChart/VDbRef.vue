<template>
  <g ref="root" :id="`ref-${id}`" :class="{
    ...
    'db-ref__selected': selected
  }" @click="handleClick" @mouseenter.passive="onMouseEnter" @mouseleave.passive="onMouseLeave">
...
const props = defineProps({
  ...
  token: Object,
  containerRef: Object,
  selected: Boolean // New prop to track if this ref is selected
})
